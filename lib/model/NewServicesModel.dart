...
NewServicesModel servicesModelFromJson(String str) => NewServicesModel.fromJson(json.decode(str));

String servicesModelToJson(NewServicesModel data) => json.encode(data.toJson());

class NewServicesModel {
  NewServicesModel({
    this.status,
    this.message,
    this.totalInCart,
  ...
  factory NewServicesModel.fromJson(Map<String, dynamic> json) => NewServicesModel(
    status: json["status"],
