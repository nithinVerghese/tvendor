...
OrderDetailModel1 orderDetailModelFromJson(String str) => OrderDetailModel1.fromJson(json.decode(str));

String orderDetailModelToJson(OrderDetailModel1 data) => json.encode(data.toJson());
...
class OrderDetailModel1 {
  ...
  factory OrderDetailModel1.fromJson(Map<String, dynamic> json) => OrderDetailModel1(
    ...
    total: json["total"],
    result: List<OrderDetailResult>.from(json["result"].map((x) => OrderDetailResult.fromJson(x))),
  );
