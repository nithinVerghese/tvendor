...
class GccTabBar extends StatefulWidget {

  @override
  _GccTabBarState createState() => _GccTabBarState();
}

class _GccTabBarState extends State<GccTabBar>
  ...
  void _hitApiServices(int index) {
    ...
    dataModel.clear();
    setState(() {});
    services.fetchServices(vendorCategoryModel[index].id.toString(), 'GCC', 'Clearance documents')
        .then((result) {
      if (result["status"] == true) {
        isServicePresent = "";
