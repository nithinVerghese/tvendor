...
class BahrainTabBar extends StatefulWidget {

  @override
  _BahrainTabBarState createState() => _BahrainTabBarState();
}

class _BahrainTabBarState extends State<BahrainTabBar>
          ...
          child: RaisedGradientButton(
              ...
              onPressed: () async {
                ...
                if(totalItem > 0){
                  ...
                  prefs.setString('service_added', 'Yes');
                  // prefs.getString('service_added');
                  serviceItemList.setTabPosition(0);
                  Get.to(OrderBottomBarIndex());
                }else{
                  getSnackBar(null, 'Add a service');
                }
              }
          ),
        ),
  ...
  Widget _tabView(BuildContext context) {
    ...
    print('length ==> ${vendorCategoryModel.length}');

    return TabBarView(
      controller: _nestedTabController,
      children: List<Widget>.generate(vendorCategoryModel.length, (int index) {
        return isServicePresent.isNotEmpty  ? Center(
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              SvgPicture.asset(
                        ...
                        itemBuilder: (context, i) {
                          return GestureDetector(
                            onTap: () async {
                              ...
                              amountCon.text = dataModel[index].services[i].serviceFee == null ? '':dataModel[index].services[i].serviceFee;
                              dataModel[index].services[i].expressService == 'Yes' ? express = true:express = false;
                              // dataModel[index].services[i].expressServiceTime
                              print("${dataModel[index].services[i].expressServiceTime}");
                              print("$expressTime");
                              expressTime = '${dataModel[index].services[i].expressServiceTime} day';
                              // expressTime = '1 day';
                              print("$expressTime");

                              print('serviceNameEn => ${dataModel[index].services[i].serviceId.toString()}');
                              addServiceDialog(context,dataModel[index].services[i].serviceId.toString(),'Enter the service price','${dataModel[index].services[i].serviceNameEn}',(){
  ...
  void _hitApiServices(int index) {
    ...
    dataModel.clear();
    setState(() {});
    services.fetchServices(vendorCategoryModel[index].id.toString(), 'Bahraini', 'Clearance documents')
        .then((result) {
      if (result["status"] == true) {
        isServicePresent = "";
        totalItem = result["totalAddedServices"];
  ...
  void addServiceDialog(BuildContext context, var serviceID, var title, var body,Function onYesPressed, Function onNoPressed,var isExpress){
    showDialog(
      context: context,
      builder: (context) {
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: TextField(
                                          ...
                                          // inputFormatters: [new FilteringTextInputFormatter.deny(new RegExp('[.0-9]')),],
                                ...
                                express ?Container(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      DropdownButton(
                                          value: expressTime == null || expressTime.isEmpty || expressTime == ''? '0 day':expressTime,
                                          underline: Container(),
                                          elevation: 0,
                                          ...
                                          items: [
                                            DropdownMenuItem(
                                              child: Text('0 day',style: Theme.of(context)
                                                  .textTheme
                                                  .bodyText1
                                                  .copyWith(
                                                fontFamily: FontStrings.Roboto_Regular,
