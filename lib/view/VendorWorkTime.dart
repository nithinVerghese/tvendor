...
import 'package:takhlees_v/widget/LoadingDialog.dart';
import 'package:takhlees_v/widget/RaisedGradientButton.dart';
import 'package:takhlees_v/widget/snackBar.dart';
import 'package:intl/intl.dart';

class VendorWorkTime extends StatefulWidget {
  @override
  _VendorWorkTimeState createState() => _VendorWorkTimeState();
}


class _VendorWorkTimeState extends State<VendorWorkTime> {
            ...
            children: [
              ...
              Padding(
                ...
                child: RaisedGradientButton(
                    ...
                    onPressed: (){
    print('''
   checkBoxSunday  : $checkBoxSunday
checkBoxMonday  : $checkBoxMonday
checkBoxTuesday  : $checkBoxTuesday
checkBoxWednesday  : $checkBoxWednesday
checkBoxThursday  : $checkBoxThursday
checkBoxFriday  : $checkBoxFriday
checkBoxSaturday  : $checkBoxSaturday
                      ''');
    if(checkBoxSunday||checkBoxMonday||checkBoxTuesday||checkBoxWednesday||checkBoxThursday||checkBoxFriday||checkBoxSaturday){
    Get.to(VendorService());
    }else{
    getSnackBar(null,'Add at list one working availability');
    }
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Select the day and time you’re working. You can always change it in settings.'.tr,
    ...
    return Column(
      children: [
        ...
        enable == 0
            ...
            ? Column(
          children: [
            vendorAvailableModel.available != null ? Column(
              children: List.generate(vendorAvailableModel.available.sunday.workingHours.length, (index) => Slidable(
                  secondaryActions: <Widget>[
                    GestureDetector(
                      onTap: (){
                        hitApiDelete(context,'${vendorAvailableModel.available.sunday.workingHours[index].id}');
                      },
                      child: Container(
            ...
            vendorAvailableModel.available != null ? Column(
              children: List.generate(vendorAvailableModel.available.monday.workingHours.length, (index) => Slidable(
                  secondaryActions: <Widget>[
                    GestureDetector(
                      onTap: (){
                        hitApiDelete(context,'${vendorAvailableModel.available.monday.workingHours[index].id}');
                      },
                      child: Container(
                        height: double.infinity,
                        color: Color(0xFFD43C43),
            ...
            vendorAvailableModel.available != null ? Column(
              children: List.generate(vendorAvailableModel.available.tuesday.workingHours.length, (index) => Slidable(
                  secondaryActions: <Widget>[
                    GestureDetector(
                      onTap: (){
                        hitApiDelete(context,'${vendorAvailableModel.available.tuesday.workingHours[index].id}');
                      },
                      child: Container(
                        height: double.infinity,
                        color: Color(0xFFD43C43),
            ...
            vendorAvailableModel.available != null ? Column(
              children: List.generate(vendorAvailableModel.available.wednesday.workingHours.length, (index) => Slidable(
                  secondaryActions: <Widget>[
                    GestureDetector(
                      onTap: (){
                        hitApiDelete(context,'${vendorAvailableModel.available.wednesday.workingHours[index].id}');
                      },
                      child: Container(
                        height: double.infinity,
                        color: Color(0xFFD43C43),
            ...
            vendorAvailableModel.available != null ? Column(
              children: List.generate(vendorAvailableModel.available.thursday.workingHours.length, (index) => Slidable(
                  secondaryActions: <Widget>[
                    GestureDetector(
                      onTap: (){
                        hitApiDelete(context,'${vendorAvailableModel.available.thursday.workingHours[index].id}');
                      },
                      child: Container(
                        height: double.infinity,
                        color: Color(0xFFD43C43),
            ...
            vendorAvailableModel.available != null ? Column(
              children: List.generate(vendorAvailableModel.available.friday.workingHours.length, (index) => Slidable(
                  secondaryActions: <Widget>[
                    GestureDetector(
                      onTap: (){
                        hitApiDelete(context,'${vendorAvailableModel.available.friday.workingHours[index].id}');
                      },
                      child: Container(
                        height: double.infinity,
                        color: Color(0xFFD43C43),
            ...
            vendorAvailableModel.available != null ? Column(
              children: List.generate(vendorAvailableModel.available.saturday.workingHours.length, (index) => Slidable(
                  secondaryActions: <Widget>[
                    GestureDetector(
                      onTap: (){
                        hitApiDelete(context,'${vendorAvailableModel.available.saturday.workingHours[index].id}');
                      },
                      child: Container(
                        height: double.infinity,
                        color: Color(0xFFD43C43),
                            ...
                            Padding(
                              ...
                              child: RaisedGradientButton(
                                  ...
                                  onPressed: () {
                                    ...
                                    hitApiAdd(context,day, fromTime, toTime);
                                    DateTime now = DateTime.now();
                                    fromTime = DateFormat('kk:mm').format(now);
                                    toTime = DateFormat('kk:mm').format(now);
                                    print('---------day: $day ,fromTime: $fromTime,toTime: $toTime');
  ...
  hitApi(BuildContext context){
    ...
    vendorAvailabilityList.fetchServices().then(
          ...
          if (result["status"] == true) {
            ...
            print("------${vendorAvailableModel.availableDay}");
            if(vendorAvailableModel.availableDay.contains('Sunday')){
              setState(() {checkBoxSunday = true;});
            }else{
              setState(() {checkBoxSunday = false;});
            }
            if(vendorAvailableModel.availableDay.contains('Monday')){
              setState(() {checkBoxMonday = true;});
            }else{
              setState(() {checkBoxMonday = false;});
            }
            if(vendorAvailableModel.availableDay.contains('Tuesday')){
              setState(() {checkBoxTuesday = true;});
            }else{
              setState(() {checkBoxTuesday = false;});
            }
            if(vendorAvailableModel.availableDay.contains('Wednesday')){
              setState(() {checkBoxWednesday = true;});
            }else{
              setState(() {checkBoxWednesday = false;});
            }
            ...
            if(vendorAvailableModel.availableDay.contains('Friday')){
              setState(() {checkBoxFriday = true;});
            }else{
              setState(() {checkBoxFriday = false;});
            }
            if(vendorAvailableModel.availableDay.contains('Saturday')){
              setState(() {checkBoxSaturday = true;});
            }else{
              setState(() {checkBoxSaturday = false;});
            }
            setState(() {});
            print('------- checkBoxThursday = $checkBoxThursday');
          } else {
            // Get.back();
  ...
  hitApiAdd(BuildContext context,String day, String open, String close){
    loadingDialog(context);
  ...
  hitApiDelete(BuildContext context,String id) {
    loadingDialog(context);
