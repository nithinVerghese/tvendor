...
class SettingsBottomBarIndex extends StatefulWidget {
  @override
  _SettingsBottomBarIndexState createState() => _SettingsBottomBarIndexState();
}

class _SettingsBottomBarIndexState extends State<SettingsBottomBarIndex> {

  int _selectedItemIndex = 3;//bottom bar
  final tab = [
    OrderScreen(),
    HistoryScreen(),
    ChatScreen(),
